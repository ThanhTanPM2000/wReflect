import { default as Board } from './boardTypeDefs';
import { default as Column } from './columnTypeDefs';
...
export default [Queries, Mutations, Board, Column, Member, Opinion, Profile, Remark, Team, User];
