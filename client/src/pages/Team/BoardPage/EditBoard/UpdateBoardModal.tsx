...
export default function UpdateBoardModal({ teamId, board, visible, setVisible }: Props) {
  ...
  const [updateBoard, { loading: isUpdatingBoard }] = useMutation<
          ...
          <div className="config-column-board-modal">
            ...
            <div style={{ marginTop: '10px', width: '100%' }}>
              ...
              <div className="buttonGenerate">
                <Button loading={isUpdatingBoard} htmlType="submit" size="large">
